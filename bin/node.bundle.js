...
/******/ 	__webpack_require__.p = "C:\\Users\\AranM\\Projects\\botpress-10\\packages\\functionals\\botpress-audience";
/******/
...
module.exports = {
  ...
  ready: function ready(bp) {
    var router = bp.getRouter('botpress-audience');
    ...
    router.post('/users', function (req, res) {
      ...
      bp.users.list(limit, from).then(function (values) {
        res.send(values);
      }).catch(function (err) {
    ...
    router.get('/users/count', function (req, res) {
      bp.users.count().then(function (count) {
